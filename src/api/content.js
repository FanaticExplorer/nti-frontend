...
export const createFaq = (data) => api.post('/content/faq', data)
export const updateFaq = (id, data) => api.patch(`/content/faq/${id}`, data)
export const deleteFaq = (id) => api.delete(`/content/faq/${id}`)
